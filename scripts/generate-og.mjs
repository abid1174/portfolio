...
function template({ eyebrow, heading, accent, accent2 }) {
  ...
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="100%" stop-color="#f4eedd"/>
    </linearGradient>
    ...
    <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
      <path d="M48 0H0V48" fill="none" stroke="#eae1cb" stroke-width="1"/>
    </pattern>
  </defs>
  ...
  <style>
    .h { font-family: -apple-system, BlinkMacSystemFont, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 64px; font-weight: 600; fill: #26241f; letter-spacing: -2px; }
    .eyebrow { font-family: 'SF Mono', Menlo, monospace; font-size: 20px; font-weight: 600; fill: ${accent}; letter-spacing: 4px; }
    .name { font-family: -apple-system, BlinkMacSystemFont, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 26px; font-weight: 600; fill: #26241f; }
    .role { font-family: 'SF Mono', Menlo, monospace; font-size: 17px; fill: #837d71; letter-spacing: 2px; }
  </style>
  ...
  <rect x="80" y="496" width="56" height="56" rx="10" fill="#f3ecdb" stroke="#ddd2b6"/>
  ...
  <circle cx="1060" cy="330" r="9" fill="#2a6398" opacity="0.8"/>
  <path d="M1060 159v72M1060 249v72" stroke="#ddd2b6" stroke-width="2"/>
</svg>`;
}
