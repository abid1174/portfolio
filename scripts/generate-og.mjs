...
function template({ eyebrow, heading, accent, accent2 }) {
  ...
  <defs>
    ...
    <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
      <path d="M48 0H0V48" fill="none" stroke="#1b2030" stroke-width="1"/>
    </pattern>
  </defs>
  ...
  <style>
    .h { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 64px; font-weight: 700; fill: #e9edf5; letter-spacing: -2px; }
    .eyebrow { font-family: 'SF Mono', Menlo, monospace; font-size: 20px; font-weight: 600; fill: ${accent}; letter-spacing: 4px; }
    .name { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 26px; font-weight: 600; fill: #e9edf5; }
    .role { font-family: 'SF Mono', Menlo, monospace; font-size: 17px; fill: #6d7689; letter-spacing: 2px; }
  </style>
  ...
  <rect x="80" y="496" width="56" height="56" rx="14" fill="#10131c" stroke="#232a3d"/>
  ...
  <circle cx="1060" cy="330" r="9" fill="#34d8c0" opacity="0.8"/>
  <path d="M1060 159v72M1060 249v72" stroke="#232a3d" stroke-width="2"/>
</svg>`;
}
